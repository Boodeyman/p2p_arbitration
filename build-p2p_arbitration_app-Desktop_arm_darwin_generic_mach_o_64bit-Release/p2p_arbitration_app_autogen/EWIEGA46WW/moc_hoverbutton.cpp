...
#include "../../../p2p_arbitration_app/hoverbutton.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSHoverButtonENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSHoverButtonENDCLASS_t qt_meta_stringdata_CLASSHoverButtonENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11),  // "HoverButton"
        QT_MOC_LITERAL(12, 7),  // "hovered"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 9)   // "isHovered"
    },
    "HoverButton",
    "hovered",
    "",
...
void HoverButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->hovered((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HoverButton::*)(bool );
            if (_t _q_method = &HoverButton::hovered; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HoverButton::hovered(bool _t1)
{
